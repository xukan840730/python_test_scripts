...
def test_main():
    ...
    iter_count = 60
    halflife_inv = 3.0
    xs1 = generate_curve_inv(x0, x_goal, halflife_inv, dt, iter_count)
    ...
    xs2 = generate_double_spring_curve_inv(x0, x_goal, halflife_inv, dt, iter_count)  # xs2 is double-spring.
